...
export const DEFAULT_THEME_NAME = "deep-space";
export const DEFAULT_THEME: ThemeConfig = { name: DEFAULT_THEME_NAME };

export const DEFAULT_DEPLOY: DeployConfig = { targets: [] };
