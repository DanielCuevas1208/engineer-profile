...
.visual-label { position: absolute; right: 16px; bottom: 16px; padding: 7px 9px; border: 1px solid rgba(255,255,255,0.18); border-radius: 5px; background: var(--visual-shade); color: var(--accent-soft); }
...
<body>
  <div class="site-shell">
    ...
    return { indexPath, projectCount: projects.length, theme: theme.name, generatedAt };
  } finally {
    db.close();
  }
}
