...
import { resolveTheme, themeRootCss, type SiteTheme } from "../theme/index.js";
...
function siteCss(theme: SiteTheme): string {
  return `
${themeRootCss(theme)}
...
.hero-aside { padding: 22px; border: 1px solid var(--line); border-radius: 14px; background: linear-gradient(145deg, var(--panel-from), var(--panel-to)); box-shadow: var(--shadow); }
...
.audit-panel { display: grid; grid-template-columns: 1fr auto; gap: 20px; align-items: center; margin: 26px 0 80px; padding: 18px 20px; border: 1px solid var(--line); border-radius: 10px; background: var(--ink-soft); }
...
.project-card { display: grid; grid-template-columns: minmax(280px, 0.8fr) minmax(0, 1.2fr); overflow: hidden; margin-bottom: 24px; border: 1px solid var(--line); border-radius: 16px; background: linear-gradient(135deg, var(--panel-from), var(--panel-to)); box-shadow: var(--shadow); }
...
.placeholder { display: flex; min-height: 310px; align-items: center; justify-content: center; flex-direction: column; gap: 7px; color: var(--blue); background: repeating-linear-gradient(135deg, color-mix(in srgb, var(--blue) 5%, transparent), color-mix(in srgb, var(--blue) 5%, transparent) 1px, transparent 1px, transparent 14px); }
.placeholder small { color: var(--muted); font: 0.68rem/1 "SFMono-Regular", Consolas, monospace; text-transform: uppercase; }
.visual-label { position: absolute; right: 16px; bottom: 16px; padding: 7px 9px; border: 1px solid rgba(255,255,255,0.18); border-radius: 5px; background: var(--overlay); color: var(--blue-soft); }
...
.tag { padding: 5px 9px; border: 1px solid color-mix(in srgb, var(--mint) 26%, transparent); border-radius: 999px; color: var(--mint); font: 0.68rem/1 "SFMono-Regular", Consolas, monospace; }
...
.change-preview code { padding: 2px 4px; border-radius: 3px; color: var(--mint); background: color-mix(in srgb, var(--mint) 8%, transparent); font: 0.76rem "SFMono-Regular", Consolas, monospace; }
...
.audit-list li { display: grid; grid-template-columns: 150px 72px 1fr; gap: 12px; padding: 8px 0; border-bottom: 1px solid var(--line); color: var(--muted); font: 0.72rem/1.4 "SFMono-Regular", Consolas, monospace; }
