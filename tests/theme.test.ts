...
import { resolveTheme, isKnownTheme, listThemeNames } from "../src/theme/themes.js";
import { DEFAULT_CONFIG } from "../src/types.js";

const TEST_DATA = "data/test-theme";
const TEST_OUTPUT = "output/test-theme";
...
describe("theme configuration", () => {
  it("loads a valid theme from the configuration file", () => {
    const dir = "data/test-theme-config";
  ...
  it("rejects an unknown theme in the configuration file", () => {
    const dir = "data/test-theme-config-bad";
    mkdirSync(dir, { recursive: true });
    const file = join(dir, "portfolio.json");
